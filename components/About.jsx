                ...
                <p className='uppercase text-3xl tracking-widest text-[#298789]'>A propos</p>
                  <h2 className='py-4'>Qui suis-je ?</h2>
                      <div className='py-7 p-8 bg-[#FFFF] shadow-xl rounded-xl text-black-600'>
                          ...
                          <p>Passionné de surf, c'est en 2007 que je décide de créer ma propre entreprise "karv and Co." spécialisée dans la fabrication de planches de surf sur mesure.</p><br />
                          <p>Après plus de dix années d’activité à mon compte, j’entreprends en 2021 de suivre une formation en ligne chez
                             ...
                             <p>Pour finir, j'ai suivi cette année, une formation en spécialité "Graphisme et Internet" à l'IFR de la Réunion afin de proposer mes compétences en création de logos et de travailler au mieux l'esthétique des sites web créés.</p><br />
